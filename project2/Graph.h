...
private:
    ...
    unordered_set<string> m_nodes;
    unordered_map<string, string> Disjoint;
    string get_set(string curr);
    void merge_set(string p, string q);
    static bool tuple_compare(const tuple<string, string, double> & p, const tuple<string, string, double> & q);
};
